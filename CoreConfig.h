...
#define CORE_SIM800_PULL_GPRS_BY_PING // закомментировать, если не надо периодически пинговать выбранный хост (нужно, чтобы поддерживать GPRS-соединение при очень редких запросах в сеть)
#define CORE_SIM800_PING_INTERVAL 45000 // интервал в миллисекундах для пинга
#define CORE_SIM800_PING_HOST F("ya.ru") // хост, который пингуем
